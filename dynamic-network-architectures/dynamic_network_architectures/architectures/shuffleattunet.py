...
class ShuffleAttPlainConvUNet(nn.Module):
    def __init__(self,
                 input_channels: int,
                 n_stages: int,
        ...
        self.encoder = ShuffleAttPlainConvEncoder(input_channels, n_stages, features_per_stage, conv_op, kernel_sizes,
                                                  strides,
                                                  n_conv_per_stage, conv_bias, norm_op, norm_op_kwargs, dropout_op,
                                                  dropout_op_kwargs, nonlin, nonlin_kwargs, return_skips=True,
                                                  nonlin_first=nonlin_first)
        self.decoder = ShuffleAttUNetDecoder(self.encoder, num_classes, n_conv_per_stage_decoder, deep_supervision,
                                             nonlin_first=nonlin_first)
        print('using shuffleattention unet...')
...
class ShuffleAttPlainConvEncoder(nn.Module):
    def __init__(self,
                 input_channels: int,
                 n_stages: int,
                 features_per_stage: Union[int, List[int], Tuple[int, ...]],
        ...
        for s in range(n_stages):
            ...
            if pool == 'max' or pool == 'avg':
                ...
                raise RuntimeError()
            stage_modules.append(ShuffleAttStackedConvBlocks(
...
class ShuffleAttUNetDecoder(nn.Module):
    def __init__(self,
                 encoder: Union[ShuffleAttPlainConvEncoder],
                 num_classes: int,
        ...
        for s in range(1, n_stages_encoder):
            ...
            stages.append(ShuffleAttStackedConvBlocks(
...
class ShuffleAttStackedConvBlocks(nn.Module):
    def __init__(self,
                 num_convs: int,
                 conv_op: Type[_ConvNd],
                 input_channels: int,
